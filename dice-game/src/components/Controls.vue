<template>
  <div class="controls">
      ...
      <input :disabled="isPlaying" :value="finalScore" @input="$emit('handleChangeFinalScore', $event)" type="number" placeholder="Final score" class="final-score" />
  </div>
</template>
